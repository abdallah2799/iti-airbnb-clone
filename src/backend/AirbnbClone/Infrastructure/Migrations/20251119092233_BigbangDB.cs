...
{
    /// <inheritdoc />
    public partial class BigbangDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GovernmentIdVerified = table.Column<bool>(type: "bit", nullable: false),
                    VerifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HostResponseRate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    HostResponseTimeMinutes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWishlists", x => new { x.ApplicationUserId, x.ListingId });
                    table.ForeignKey(
                        name: "FK_UserWishlists_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserWishlists_Users_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWishlists_ListingId",
                table: "UserWishlists",
                column: "ListingId");
        }
