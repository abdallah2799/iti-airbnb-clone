...
export class AdminService {
    ...
    // ============= USERS =============
    getUsers(page: number = 1, pageSize: number = 10, search?: string, sortBy?: string, isDescending?: boolean): Observable<PagedResult<AdminUserDto>> {
    ...
    // ============= LISTINGS =============
    getListings(page: number = 1, pageSize: number = 10, status?: string, search?: string, sortBy?: string, isDescending?: boolean): Observable<PagedResult<AdminListingDto>> {
        let params = new HttpParams()
            .set('page', page.toString())
            .set('pageSize', pageSize.toString());
    ...
    // ============= BOOKINGS =============
    getBookings(page: number = 1, pageSize: number = 10, status?: string, search?: string, sortBy?: string, isDescending?: boolean): Observable<PagedResult<AdminBookingDto>> {
        let params = new HttpParams()
            .set('page', page.toString())
            .set('pageSize', pageSize.toString());
    ...
    // ============= REVIEWS =============
    getReviews(page: number = 1, pageSize: number = 10, search?: string, sortBy?: string, isDescending?: boolean): Observable<PagedResult<AdminReviewDto>> {
        let params = new HttpParams()
            .set('page', page.toString())
            .set('pageSize', pageSize.toString());
