...
@Component({
    ...
    <div 
      (click)="onClick()"
      class="flex items-center justify-between border border-gray-300 rounded-full shadow-sm hover:shadow-md cursor-pointer py-2.5 pl-6 pr-2 bg-white transition-all duration-200 min-w-[300px]"
    >
      ...
      <div class="flex items-center gap-3">
        <span class="text-sm text-gray-600">Add guests</span>
